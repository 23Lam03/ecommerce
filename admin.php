								...
								<ul>
									<li class="dropdown profile_details_drop">
										...
										<ul class="dropdown-menu drp-mnu">
											<li> <a href="logout.php"><i class="fa fa-sign-out"></i> Logoutt</a> </li>
										</ul>
									</li>
								</ul>
							</div>
...
<!--heder end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="admin.php">Home Page</a> <i class="fa fa-angle-right"></i></li>
            </ol>
						  ...
						  <div class="row">
						  	...
						  	<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
						  		<div class="list-group">
								    <a href="admin.php" class="list-group-item active">Home page</a>
								    <a href="productadmin.php" class="list-group-item">Product Management</a>
								    <a href="categoryadmin.php" class="list-group-item">Product Management</a>
								    <a href="supplieradmin.php" class="list-group-item">Manufacturer management</a>
								    <a href="ordersadmin.php" class="list-group-item">Order management</a>
								  </div>
						  	</div>
						  	<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
